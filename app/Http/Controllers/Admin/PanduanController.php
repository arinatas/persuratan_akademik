...
class PanduanController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'gambar1' => 'nullable|file|mimes:jpg',
            'gambar2' => 'nullable|file|mimes:jpg',
            'gambar3' => 'nullable|file|mimes:jpg',
            'gambar4' => 'nullable|file|mimes:jpg',
            'gambar5' => 'nullable|file|mimes:jpg',
            'gambar6' => 'nullable|file|mimes:jpg',
            'gambar7' => 'nullable|file|mimes:jpg',
            'gambar8' => 'nullable|file|mimes:jpg',
