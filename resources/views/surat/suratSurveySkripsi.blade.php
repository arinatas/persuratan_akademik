...
<html>
    <head>
        ...
        <title>Surat Izin Survey Skripsi</title>
    ...
    <body>
    @foreach ($suratSurveySkripsi as $item)
        <div class="wrapper">
            <!-- Main content -->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <p style="text-align: justify; text-indent: 30px;">
                                                    Sehubungan dengan penyusunan tugas skripsi yang saat ini sedang dijalani oleh mahasiswa kami, maka kami mohon kepada Bapak/Ibu untuk memberikan izin survey wawancara dan observasi untuk skripsi mahasiswa kami yang berjudul “{{ $item->topik }}”. Adapun mahasiswa kami adalah sebagai berikut :
                                                </p>
                                            </div>
                                        </div>
                                    </address>
