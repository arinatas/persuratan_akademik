...
<html>
    <head>
        ...
        <title>Surat Survey Matakuliah</title>
    ...
    <body>
    @foreach ($suratSurveyMatkul as $item)
        <div class="wrapper">
            <!-- Main content -->
                                            ...
                                            <div class="col-12">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>Perihal</td>
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                        <td>: &nbsp;&nbsp;&nbsp;Surat Ijin Survei Mata Kuliah</td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                                    ...
                                    <address>
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <p style="text-align: justify; text-indent: 30px; margin-bottom: -2px">
                                                    Sehubungan dengan penyusunan tugas mata kuliah {{ $item->matkul }} yang saat ini diikuti oleh mahasiswa kami, maka dengan ini dimohonkan  kepada Bapak/Ibu untuk memberikan izin survei untuk pengambilan data mengenai {{ $item->keterangan }} kepada mahasiswa kami di Instansi/Perusahaan {{ $item->perusahaan }} yang Bapak/Ibu Pimpin. Adapun mahasiswa kami adalah sebagai berikut :
                                                </p>
                                            </div>
                                        </div>
                                    </address>
