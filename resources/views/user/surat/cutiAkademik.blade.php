							...
							<div id="kt_content_container" class="container-xxl">
								...
								<div class="card mb-15">
									...
									<div class="card-body pb-10">
										...
										<!--begin::Row-->
										<form action="{{ url('suratCutiAkademik') }}" method="POST" target="_blank">
											<div class="row g-5 g-xl-8">
												...
												<div class="col-lg-12">
													<label class="required form-label">Alasan Cuti</label>
												...
												<div class="col-lg-6">
													...
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="tahun" required>
