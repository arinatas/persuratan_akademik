							...
							<div id="kt_content_container" class="container-xxl">
								...
								<div class="card mb-15">
									...
									<div class="card-body pb-10">
										...
										<!--begin::Row-->
										<form action="{{ url('suratRekomendasiProposalSkripsi') }}" method="POST" target="_blank">
											<div class="row g-5 g-xl-8">
												...
												<div class="col-lg-6">
                                                    ...
                                                    <input type="hidden" value="{{ $biomhs[0]->dosenPA->jabatan }}" class="form-control form-control-solid" readonly name="dosenPA_jabatan"/>
												</div>
												<div class="col-lg-6">
												...
												<div class="col-lg-12">
													...
													<!-- <input type="text" value="" class="form-control form-control-solid" required name="tahun_ajaran" /> -->
                                                    <select class="form-control form-control-solid" required name="tahun_ajaran">
                                                        <option value="">Pilih Tahun Ajaran</option>
                                                        <?php
                                                            $currentYear = date("Y");
                                                            $startYear = 2023; // Tahun awal yang diinginkan
