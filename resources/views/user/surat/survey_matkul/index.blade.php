														...
														<tr>
															...
															<td>
																...
																@if ($item->status_acc == 1)
																	<a href="{{ route('userSuratSurveyMatkulPrint', $item->id) }}" class="btn btn-sm btn-success btn-action" target="blank" data-toggle="tooltip" title="Unduh Surat"><i class="fas fa-download"></i></a>
																@endif
