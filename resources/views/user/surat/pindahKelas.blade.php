							...
							<div id="kt_content_container" class="container-xxl">
								...
								<div class="card mb-15">
									...
									<div class="card-body pb-10">
										...
										<!--begin::Row-->
										<form action="{{ url('suratPindahKelas') }}" method="POST" target="_blank">
											<div class="row g-5 g-xl-8">
												...
												<div class="col-lg-3">
													...
													<input type="text" value="{{ $biomhs[0]->kelas }}" class="form-control form-control-solid" required name="kelasOld" />
												</div>
												<div class="col-lg-12">
													<label class="required form-label">Alamat</label>
													<input type="text" value="" class="form-control form-control-solid" required name="alamat" />
												</div>
												<div class="col-lg-9">
												...
												<div class="col-lg-3">
													<label class="required form-label">Pindah Ke Kelas</label>
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="kelasNow" required>
