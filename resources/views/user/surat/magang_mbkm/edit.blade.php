										...
										<form action="{{ url('userSuratMagangMBKMUpdate', $mySuratMbkm->id) }}" method="POST">
											<div class="row g-5 g-xl-8">
												...
												<div class="col-lg-4">
													...
													<input type="text" value="{{ $mySuratMbkm->nim2 }}" class="form-control form-control-solid" name="nim2"/>
												</div>
												<div class="col-lg-4">
													<label class="form-label">Nama</label>
													<input type="text" value="{{ $mySuratMbkm->nama2 }}" class="form-control form-control-solid" name="nama2"/>
												</div>
												<div class="col-lg-4">
													...
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="prodi2">
														...
														<option value="Sistem Informasi Akutansi" {{ $mySuratMbkm->prodi2 == 'Sistem Informasi Akutansi' ? 'selected' : '' }}>Sistem Informasi Akutansi</option>
														<option value="Akutansi" {{ $mySuratMbkm->prodi2 == 'Akutansi' ? 'selected' : '' }}>Akutansi</option>
														<option value="Manajemen" {{ $mySuratMbkm->prodi2 == 'Manajemen' ? 'selected' : '' }}>Manajemen</option>
														<option value="DKV" {{ $mySuratMbkm->prodi2 == 'DKV' ? 'selected' : '' }}>DKV</option>
														<option value="Bisnis Digital" {{ $mySuratMbkm->prodi2 == 'Bisnis Digital' ? 'selected' : '' }}>Bisnis Digital</option>
                                                    </select>
												</div>
												<hr>
												<div class="heading text-start my-0">
												...
												<div class="col-lg-4">
													<label class="form-label">NIM</label>
													<input type="text" value="{{ $mySuratMbkm->nim3 }}" class="form-control form-control-solid" name="nim3"/>
												</div>
												<div class="col-lg-4">
													<label class="form-label">Nama</label>
													<input type="text" value="{{ $mySuratMbkm->nama3 }}" class="form-control form-control-solid" name="nama3"/>
												</div>
												<div class="col-lg-4">
													<label class="form-label">Prodi</label>
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="prodi3">
														...
														<option value="Sistem Informasi Akutansi" {{ $mySuratMbkm->prodi3 == 'Sistem Informasi Akutansi' ? 'selected' : '' }}>Sistem Informasi Akutansi</option>
														<option value="Akutansi" {{ $mySuratMbkm->prodi3 == 'Akutansi' ? 'selected' : '' }}>Akutansi</option>
														<option value="Manajemen" {{ $mySuratMbkm->prodi3 == 'Manajemen' ? 'selected' : '' }}>Manajemen</option>
														<option value="DKV" {{ $mySuratMbkm->prodi3 == 'DKV' ? 'selected' : '' }}>DKV</option>
														<option value="Bisnis Digital" {{ $mySuratMbkm->prodi3 == 'Bisnis Digital' ? 'selected' : '' }}>Bisnis Digital</option>
                                                    </select>
												</div>
												<hr>
												<div class="heading text-start my-0">
												...
												<div class="col-lg-4">
													<label class="form-label">NIM</label>
													<input type="text" value="{{ $mySuratMbkm->nim4 }}" class="form-control form-control-solid" name="nim4"/>
												</div>
												<div class="col-lg-4">
													<label class="form-label">Nama</label>
													<input type="text" value="{{ $mySuratMbkm->nama4 }}" class="form-control form-control-solid" name="nama4"/>
												</div>
												<div class="col-lg-4">
													<label class="form-label">Prodi</label>
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="prodi4">
														...
														<option value="Sistem Informasi Akutansi" {{ $mySuratMbkm->prodi4 == 'Sistem Informasi Akutansi' ? 'selected' : '' }}>Sistem Informasi Akutansi</option>
														<option value="Akutansi" {{ $mySuratMbkm->prodi4 == 'Akutansi' ? 'selected' : '' }}>Akutansi</option>
														<option value="Manajemen" {{ $mySuratMbkm->prodi4 == 'Manajemen' ? 'selected' : '' }}>Manajemen</option>
														<option value="DKV" {{ $mySuratMbkm->prodi4 == 'DKV' ? 'selected' : '' }}>DKV</option>
														<option value="Bisnis Digital" {{ $mySuratMbkm->prodi4 == 'Bisnis Digital' ? 'selected' : '' }}>Bisnis Digital</option>
                                                    </select>
												</div>
												<hr>
												<div class="heading text-start my-0">
												...
												<div class="col-lg-4">
													<label class="form-label">NIM</label>
													<input type="text" value="{{ $mySuratMbkm->nim5 }}" class="form-control form-control-solid" name="nim5"/>
												</div>
												<div class="col-lg-4">
													<label class="form-label">Nama</label>
													<input type="text" value="{{ $mySuratMbkm->nama5 }}" class="form-control form-control-solid" name="nama5"/>
												</div>
												<div class="col-lg-4">
													<label class="form-label">Prodi</label>
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" name="prodi5">
														...
														<option value="Sistem Informasi Akutansi" {{ $mySuratMbkm->prodi5 == 'Sistem Informasi Akutansi' ? 'selected' : '' }}>Sistem Informasi Akutansi</option>
														<option value="Akutansi" {{ $mySuratMbkm->prodi5 == 'Akutansi' ? 'selected' : '' }}>Akutansi</option>
														<option value="Manajemen" {{ $mySuratMbkm->prodi5 == 'Manajemen' ? 'selected' : '' }}>Manajemen</option>
														<option value="DKV" {{ $mySuratMbkm->prodi5 == 'DKV' ? 'selected' : '' }}>DKV</option>
														<option value="Bisnis Digital" {{ $mySuratMbkm->prodi5 == 'Bisnis Digital' ? 'selected' : '' }}>Bisnis Digital</option>
                                                    </select>
												</div>
												<hr>
