                        ...
                        <div class="mt-15">
                            <form action="{{ route('update.biodata', $biodata->id ) }}" method="POST">
								...
								<div class="mb-10">
                                    ...
                                    <input type="text" value="{{$biodata->kelas}}" class="form-control form-control-solid" required name="kelas"/>
                                </div>
								<div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Prodi</label>
                                    <input type="text" value="{{$biodata->prodi}}" class="form-control form-control-solid" required name="prodi"/>
                                </div>
								<div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Fakultas</label>
                                    <input type="text" value="{{$biodata->fakultas}}" class="form-control form-control-solid" required name="fakultas"/>
                                </div>
								<div class="mb-10">
								...
								<div class="mb-10">
                                    ...
                                    <input type="text" value="{{$biodata->dosen_pa}}" class="form-control form-control-solid" required name="dosen_pa"/>
                                </div>
