                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                ...
                                                <form action="{{ route('insert.biodata') }}" method="POST">
                                                    ...
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <input class="form-control form-control-solid" type="text" name="kelas" required value=""/>
                                                    </div>
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                    ...
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <input class="form-control form-control-solid" type="text" name="fakultas" required value=""/>
                                                    </div>
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
