                                        ...
                                        <div class="table-responsive my-10 mx-8">
                                            <table class="table table-striped gy-7 gs-7">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                    @foreach ($jenisPanduans as $item)
                                                    <tr>
                                                        <td>{{ $no }}</td>
                                                        <td>{{ $item->nama }}</td>
                                                        <td>
                                                            <a href="{{ route('edit.jenisPanduan', $item->id ) }}" class="btn btn-sm btn-primary btn-action" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                                            <form id="form-delete" action="{{ route('destroy.jenisPanduan', $item->id ) }}" method="POST"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                <!--begin::Form-->
                                                <form action="{{ route('insert.jenisPanduan') }}" method="POST">
                                                    @csrf
                                                    <!--begin::Input group-->
