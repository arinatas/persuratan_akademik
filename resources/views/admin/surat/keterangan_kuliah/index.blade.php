                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pb-5">
                                        ...
                                        <div class="card-px mt-5">
                                            <form action="{{ route('suratKeteranganKuliah') }}" method="GET" class="mb-3">
                                        ...
                                        <div class="table-responsive my-10 mx-8">
                                            <table class="table table-striped gy-7 gs-7">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <td>{{ $keteranganKuliahs->firstItem() + $loop->index }}</td>
                                        ...
                                        {{ $keteranganKuliahs->appends(request()->query())->links() }}
                                        @else
