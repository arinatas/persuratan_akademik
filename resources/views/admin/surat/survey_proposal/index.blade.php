                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pb-5">
                                        ...
                                        <div class="card-px mt-5">
                                            <form action="{{ route('suratSurveyProposal') }}" method="GET" class="mb-3">
                                        ...
                                        <div class="table-responsive my-10 mx-8">
                                            <table class="table table-striped gy-7 gs-7">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $surveyProposals->firstItem() + $loop->index }}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group d-flex flex-column">
                                                                ...
                                                                <!-- Revisi Button -->
                                                                <form method="post" action="{{ route('revisi.suratSurveyProposal', $item->id) }}">
                                                                    @csrf
                                        ...
                                        {{ $surveyProposals->appends(request()->query())->links() }}
                                        @else
