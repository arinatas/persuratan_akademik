                                            ...
                                            <table class="table table-striped gy-7 gs-7">
                                                <thead>
                                                    <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                                        ...
                                                        <th class="min-w-100px">File Pedoman</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('edit.pedoman', $item->id ) }}" class="btn btn-sm btn-primary btn-action" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                                            <form id="form-delete" action="{{ route('destroy.pedoman', $item->id ) }}" method="POST"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                <!--begin::Form-->
                                                <form action="{{ route('insert.pedoman') }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <!--begin::Input group-->
                                                    ...
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                            <span class="required">File Pedoman</span>
                                                        </label>
                                                        <input class="form-control form-control-solid" type="file" name="nama_file" required/>
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Actions-->
